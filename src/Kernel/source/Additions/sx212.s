...
result = *-1
		bpl		ok
		lda		#<msg_load_warning
		ldy		#>msg_load_warning
...
msg_banner:
		dta		'Altirra SX212 R: Handler V0.1',$9B
		
msg_already_loaded:
		dta		'R: handler already loaded.',$9B
		
msg_init:
		dta		'Initializing modem...',$9B

msg_load_warning:
		dta		'Warning: modem init failed.',$9B
