...
_vdasm_pixblt_XRGB8888_to_YUV444Planar_scan_SSE2 proc
		push		edi
		push		esi
		push		ebx
...
xloop:
		...
		jns			xloop
postcheck:
		jmp			dword ptr [finaltable + esi*4 + 16]
complete:
		pop			ebx
		pop			esi
		pop			edi
...
dofinal:
		...
		jmp			dword ptr [finaltable2 + esi*4 + 12]
...
fin3:
		...
		mov			[ecx+2], dl
		jmp			complete
_vdasm_pixblt_XRGB8888_to_YUV444Planar_scan_SSE2 endp
